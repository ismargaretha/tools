...
def argenta():
    ...
    try:
        ...
        df_arge = read_pdf('https://www.argenta.be/content/dam/argenta/documents/emprunter/credit-logement/Feuille%20de%20tarifs%20Cr%C3%A9dits%20hypoth%C3%A9caires.pdf', encoding='ISO-8859-1',
                           pages=2, area=[195.43, 54.1, 739.61, 576.5], stream=True, spreadsheet=True, pandas_options={'header': None})
        df_arge0001 = df_arge.drop(df_arge.index[0:4]).drop(df_arge.index[7:31]).drop(df_arge.index[5])
    ...
    ###############################################################################################################
    ############################################ARGE0002###########################################################
        df_arge0002 = df_arge.drop(df_arge.index[0:7]).drop(df_arge.index[10:31]).drop(df_arge.index[8])
        ...
        ###############################################################################################################
    ############################################ARGE0003###########################################################
        df_arge0003 = df_arge.drop(df_arge.index[0:10]).drop(df_arge.index[13:31]).drop(df_arge.index[11])
    ...
    ###############################################################################################################
    ############################################ARGE0004###########################################################
        df_arge0004 = df_arge.drop(df_arge.index[0:13]).drop(df_arge.index[16:31]).drop(df_arge.index[14])
    ...
    ###############################################################################################################
    ############################################ARGE0005###########################################################
        df_arge0005 = df_arge.drop(df_arge.index[0:16]).drop(df_arge.index[19:31]).drop(df_arge.index[17])
        ...
        ###############################################################################################################
    ############################################ARGE0006###########################################################
        df_arge0006 = df_arge.drop(df_arge.index[0:19]).drop(df_arge.index[22:31]).drop(df_arge.index[20])
    ...
    ###############################################################################################################
    ############################################ARGE0007###########################################################
        df_arge0007 = df_arge.drop(df_arge.index[0:22]).drop(df_arge.index[25:31]).drop(df_arge.index[23])
        ...
        ###############################################################################################################
    ############################################ARGE0008###########################################################
        df_arge0008 = df_arge.drop(df_arge.index[0:25]).drop(df_arge.index[28:31]).drop(df_arge.index[26])
    ...
    ###############################################################################################################
    ############################################ARGE0009###########################################################
        df_arge0009 = df_arge.drop(df_arge.index[0:28]).drop(df_arge.index[29])
